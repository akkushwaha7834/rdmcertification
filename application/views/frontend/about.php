<section class="section-space bg-image breadcrumb-overlay position-relative"
    style="background-image: url('<?=base_url()?>public/web/assets/images/breadcrumb.jpg')">
...
<section class="section-space">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 align-self-center text-center"><img src="<?=base_url()?>public/web/assets/images/aboutus.png" alt=""
                    class="w-75"></div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-4 align-self-center">
                ...
                <a href="<?=base_url()?>certificates" class="btn-round text-dark "> View All<i class="ri-arrow-right-line"></i></a>
            </div>
            <div class="col-lg-8">
...
<section class="position-relative overlay-left bg-image section-space"
    style="background-image:url('<?=base_url()?>public/web/assets/images/cta.webp');background-attachment:fixed;">
    <div class="container position-relative z-1 py-5">
        <div class="row g-4">
            <div class="col-md-7">
                ...
                <a href="<?=base_url()?>contact" class="btn-round "> Contact Us <i class="ri-arrow-right-line"></i>
                </a>
            </div>
        </div>
    </div>
