...
<section class="section-space bg-image breadcrumb-overlay position-relative"
    style="background-image: url('<?=base_url()?>public/web/assets/images/it-servicesb.webp')">
    ...
    <div class="container">
        <div class="row theme-bg-light">
            <div class="col-md-6 py-5 px-lg-5  h-100 bg-dark">
                <img src="<?=base_url()?>public/web/assets/images/web-design.png" alt="" class="mb-4">
            ...
            <img src="<?=base_url()?>public/web/assets/images/digital-marketing.png" alt="" class="mb-4">
            ...
            <div class="col-md-6 py-5  px-lg-5 align-self-center theme-bg-light">
            <img src="<?=base_url()?>public/web/assets/images/web-developemnt.png" alt="" class="mb-4">
                <h3>Website Development</h3>
                <p>A complete web app solution for business. We work on all technologies.Our experience makes us stand out from other web development.</p>
                <a href="it-service-single.php" class="btn-round mt-4 text-dark"> Read More <i
                                                    class="ri-arrow-right-line"></i> </a>
            </div>
            <div class="col-md-6 py-5 px-lg-5  h-100 bg-dark">
                <img src="<?=base_url()?>public/web/assets/images/graphic-design.png" alt="" class="mb-4">
            ...
            <div class="col-md-6 py-5 px-lg-5  h-100 bg-dark">
                <img src="<?=base_url()?>public/web/assets/images/app.png" alt="" class="mb-4">
            ...
            <div class="col-md-6 py-5 px-lg-5  h-100 theme-bg-light">
            <img src="<?=base_url()?>public/web/assets/images/seo.png" alt="" class="mb-4">
