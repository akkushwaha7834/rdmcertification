<footer class="bg-dark bg-footer  pt-5">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="footer-widget mt-4">
          ...
          <ul class="">
            <li><a href="<?=base_url()?>"><i class="ri-arrow-right-double-fill"></i> Home</a></li>
            <li><a href="<?=base_url()?>about"><i class="ri-arrow-right-double-fill"></i> About Us</a></li>
            <li><a href="<?=base_url()?>it-services"><i class="ri-arrow-right-double-fill"></i> Services</a></li>
            <li><a href="<?=base_url()?>certificates"><i class="ri-arrow-right-double-fill"></i> Certificate</a></li>
            <li><a href="<?=base_url()?>career"><i class="ri-arrow-right-double-fill"></i> Career</a>
            </li>
            <li><a href="<?=base_url()?>contact"><i class="ri-arrow-right-double-fill"></i> Contact</a>
            </li>
          </ul>
        </div>
      </div>
      <div class="col-lg-4 col-md-6 ">
        <div class="footer-widget mt-4">
          ...
          <ul class="get-in-ul">
            <li class="text-white"><span><i class="ri-map-pin-line"></i></span> <span class="text-white"> Shop no. 4, 40
                feet road badarpur border behind Mehra petrol pump New Delhi - 110044</span></li>
    ...
    <div class="row py-4 footer-brdr">
      <div class="col-lg-12">
        <p class="copyright mb-0  text-center text-white">Copyright © 2021 <a href="https://rdmcertification.com/"
            class="text-white">RDM Certification Services</a> All rights reserved.</p>
      </div>
...
<script src="<?=base_url()?>public/web/assets/js/bootstrap/bootstrap.bundle.min.js"></script>
<script src="<?=base_url()?>public/web/assets/js/wow/wow.min.js"></script>
<script src="<?=base_url()?>public/web/assets/js/swiper/swiper-bundle.min.js"></script>
<script src="<?=base_url()?>public/web/assets/js/odometer/odometer.min.js"></script>
<script>            
